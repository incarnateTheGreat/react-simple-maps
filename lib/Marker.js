  ...
  _createClass(Marker, [{
    ...
    value: function render() {
      var _props9 = this.props,
          ...
          rotate = _props9.rotate,
          defaultZoomNumerator = _props9.defaultZoomNumerator;
      var _state = this.state,
          pressed = _state.pressed,
          hover = _state.hover;


      var scale = zoom < 8 && preserveMarkerAspect ? defaultZoomNumerator ? " scale(" + defaultZoomNumerator / zoom + ")" : " scale(" + 1 / zoom + ")" : "";
      var translation = projection(marker.coordinates);
      var rotateInput = rotate ? " rotate(" + rotate + ")" : "";
